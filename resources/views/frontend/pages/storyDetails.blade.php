...
<header class="pb-11" style="margin-top: 20px;">
    ...
    <h1 class="heading font-bold">{{ $story->name }}</h1>
</header>

<section class="pb-20 [&>p]:pb-5 [&>p]:text-primary-300">
    {!! $story->short_description !!}
    <img class="w-full pt-7 pb-12" src="{{ $story->image? url('storage/uploads/stories/'.$story->image) : asset('frontend/assets/home/home-img.png') }}" alt="" srcset="">
    {!! $story->description !!}
</section>
